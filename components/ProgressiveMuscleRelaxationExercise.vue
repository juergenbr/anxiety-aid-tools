  ...
  <section class="sektion" ref="exerciseSection">
    ...
    <div v-if="exerciseStarted && !exerciseCompleted">
      ...
      <SessionHeader
        ...
        :status-text="currentState === 'tense' ? $t('progressiveMuscleRelaxation.interface.tenseFor5') : currentState === 'relax' ? $t('progressiveMuscleRelaxation.interface.releaseFor15') : $t('progressiveMuscleRelaxation.interface.prepare')"
        ...
        <div class="flex flex-col items-center">
          ...
          <div class="flex gap-3">
            ...
            >
              ...
              <span>{{ $t('progressiveMuscleRelaxation.interface.skip') }}</span>
            </button>
